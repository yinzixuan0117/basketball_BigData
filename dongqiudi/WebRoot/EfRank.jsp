...
<% EfRankDao a=new EfRankDao();
   ...
   List<Efrank> list=a.getEfranksByPage(currentPage, 10);
   Efrank m;
 %>
 <%
...
<table class="table table-striped">
    <thead>
    	<tr>
			...
			<th scope="col">得分</th>
			<th scope="col">效率值</th>
            <th scope="col">进攻效率</th>
            <th scope="col">防守效率</th>           
            <th scope="col">助攻失误比</th>
            <th scope="col">获胜贡献值</th>
            <th scope="col">使用率</th>
			<th scope="col">正负值</th> 
       ...
       <tr>
			...
			<th scope="col"><% out.println(m.getId().get效率值()); %></th>
            <th scope="col"><% out.println(m.getId().get进攻效率()); %></th>
            <th scope="col"><% out.println(m.getId().get防守效率()); %></th>           
            <th scope="col"><% out.println(m.getId().get助攻失误比()); %></th>
            <th scope="col"><% out.println(m.getId().get获胜贡献值()); %></th>
            <th scope="col"><% out.println(m.getId().get使用率()); %></th>
			<th scope="col"><% out.println(m.getId().get正负值()); %></th> 
