...
/**
 * EfrankId entity. @author MyEclipse Persistence Tools
 */

public class EfrankId implements java.io.Serializable {
	...
	/** full constructor */
	public EfrankId(String 排名, String 球员, String 号码, String 球队, String 场次, String 首发, String 得分, String 效率值,
			String 进攻效率, String 防守效率, String 助攻失误比, String 获胜贡献值, String 进攻防守贡献, String 使用率, String 正负值, String 出场时间,
			String q) {
		this.排名 = 排名;
		this.球员 = 球员;
		this.号码 = 号码;
	...
	public String get进攻效率() {
		return this.进攻效率;
	}

	public void set进攻效率(String 进攻效率) {
		this.进攻效率 = 进攻效率;
	}

	public String get防守效率() {
		return this.防守效率;
	}

	public void set防守效率(String 防守效率) {
		this.防守效率 = 防守效率;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EfrankId))
			return false;
		EfrankId castOther = (EfrankId) other;
