...
/**
 * EfOfForeignId entity. @author MyEclipse Persistence Tools
 */

public class EfOfForeignId implements java.io.Serializable {
	...
	/** default constructor */
	public EfOfForeignId() {
	}

	/** full constructor */
	public EfOfForeignId(String 排名, String 球员, String 号码, String 球队, String 场次, String 首发, String 得分, String 效率值,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EfOfForeignId))
			return false;
		EfOfForeignId castOther = (EfOfForeignId) other;
